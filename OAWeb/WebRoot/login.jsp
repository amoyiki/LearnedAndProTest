		...
		<div class="inner">
			...
			<div class="formLogin">
				<form name="formLogin" action="userAction!login.action" id="formLogin" method="post">
					...
					<div class="tip">
						<input class="password" name="password" type="password" id="password" title="密码" 
							value="admin" nullmsg="请输入密码!" />
					</div>
						...
						<div style="float: right; padding: 3px 0; margin-right: -12px;">
							<div>
								<ul class="uibutton-group">
									<li><!-- <input class="uibutton normal" type="submit" value="登录"/> -->
							...
							<div style="float: left; margin-left: 30px;">
								<a href="javascript:void(0);"><span class="f_help">说明</span></a>
							</div>
						</div>
						<div class="clear"></div>
					</div>
